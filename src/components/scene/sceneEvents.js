export const SceneEvents = Object.freeze({
  ...
  PLACARD_HOVER_ENTER: 'profile:placard-hover-enter',
  PLACARD_HOVER_LEAVE: 'profile:placard-hover-leave',
  PLACARD_FOCUS_ENTER: 'profile:placard-focus-enter',
  PLACARD_FOCUS_LEAVE: 'profile:placard-focus-leave',
